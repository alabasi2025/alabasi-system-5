...
## مهمة عاجلة: إنشاء مثبت Windows تلقائي (.exe)

### المرحلة 1: سكريبت التثبيت التلقائي
- [ ] إنشاء Install-Alabasi5.ps1 شامل
- [ ] فحص وتثبيت المتطلبات تلقائياً (Git, Node.js, pnpm)
- [ ] تحميل المشروع من GitHub
- [ ] إعداد قاعدة البيانات تلقائياً
- [ ] إضافة البيانات التجريبية
- [ ] إنشاء اختصار على سطح المكتب

### المرحلة 2: ملف BAT للتشغيل
- [ ] إنشاء Install.bat بسيط
- [ ] إضافة معالجة الأخطاء
- [ ] إضافة رسائل واضحة

### المرحلة 3: التوثيق
- [ ] إنشاء README_WINDOWS.md مبسط
- [ ] إضافة لقطات شاشة
- [ ] إضافة حل المشاكل الشائعة

### المرحلة 4: الاختبار والتسليم
- [ ] رفع الملفات إلى GitHub
- [ ] إنشاء Release مع ملف التثبيت
- [ ] تسليم الرابط للمستخدم

## مشروع ضخم: تحويل النظام إلى PHP + XAMPP

### المرحلة 1: البنية الأساسية
- [ ] إنشاء مجلد php-version/
- [ ] إنشاء ملف config.php للإعدادات
- [ ] إنشاء ملف database.php للاتصال بقاعدة البيانات
- [ ] إنشاء جداول قاعدة البيانات (24 جدول)
- [ ] إنشاء نظام المصادقة (login/logout)
- [ ] إنشاء نظام الجلسات (sessions)

### المرحلة 2: الوظائف الأساسية
- [ ] صفحة دليل الحسابات (عرض + إضافة + تعديل + حذف)
- [ ] صفحة القيود اليومية (عرض + إضافة)
- [ ] صفحة سندات القبض (عرض + إضافة + طباعة)
- [ ] صفحة سندات الصرف (عرض + إضافة + طباعة)
- [ ] صفحة الحسابات التحليلية
...
- [ ] المساعد الذكي (OpenAI API)
- [ ] النسخ الاحتياطي التلقائي
- [ ] التصدير إلى Excel
- [ ] رفع الملفات والصور

### المرحلة 5: الواجهة والتصميم
- [ ] تصميم Bootstrap 5
- [ ] دعم RTL للعربية
- [ ] Responsive Design
- [ ] Dark Mode
...
- [ ] سكريبت SQL للبيانات التجريبية (80+ سجل)
...
## مهام عاجلة: إصلاح مشاكل التثبيت على Windows

- [ ] إصلاح ترميز ملف Install-Alabasi5.ps1 (أحرف عربية مشوهة)
- [ ] إصلاح أمر pnpm dev ليعمل على Windows (NODE_ENV)
- [ ] إضافة package.json script للتشغيل على Windows
- [ ] اختبار المثبت بالكامل
